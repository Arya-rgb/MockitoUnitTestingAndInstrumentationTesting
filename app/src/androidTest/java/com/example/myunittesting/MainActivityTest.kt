...
class MainActivityTest {
    private val dummyVolume = "588.0"
    private val dummyCircumference = "104.0"
    private val dummySurfaceArea = "691488.0"
    ...
    //test untuk Circumference
    @Test
    fun assertGetCircumference() {
        //onview untuk menemukan elemen atau kompononen antarmuka untuk di uji
        //viewactions untuk memberikan event untuk melakukan sebuah aksi pada komponen antar muka yang diuji.
        //.check  untuk mengecek sebuah kondisi atau state dari komponen yang diuji.
